# Trazabilidad - ShowroomGriffin

Registro acumulativo de decisiones y ajustes por etapa y agente. Registra las conversaciones
con el usuario, las decisiones tomadas y el estado del ciclo de vida de cada feature
(análisis -> diseño -> arquitectura -> presupuesto -> implementación -> QA).

El estado vigente del proyecto (fecha de inicio, última actualización y estado del ciclo por agente)
vive en `metadata.md`, no en este log.

## Cierre de Sprint — Calibración Real

### 2026-05-20 - presupuestador
- Etapa: Cierre de calibración
- Cambio: Cierre presupuestador
...
### 2026-07-02 - qa
- Etapa: verificación puntual de cambio acotado
- Cambio: QA puntual V9 (fast-path redirect post-ajuste de stock)
...
### 2026-07-30 - analista-funcional
- Etapa: Discovery/Análisis (Ask mode, sin código)
- Cambio: Discovery V10 (carga masiva de stock + filtros completos en Consulta de Stock)
...
### 2026-07-30 - disenador-funcional
- Etapa: Diseño (Ask mode, sin código)
- Cambio: Orquestador: Diseño funcional V10 (mismo día, sesión orquestada "implementar")
...
### 2026-07-30 - arquitecto-mvc
- Etapa: Arquitectura (Ask mode, sin código)
- Cambio: Orquestador: Arquitectura técnica V10 (mismo día)
...
### 2026-07-30 - presupuestador
- Etapa: Presupuesto (Ask mode, sin código)
- Cambio: Orquestador: Presupuesto V10 (mismo día) — GATE DURO, pendiente aprobación del cliente
...
### 2026-07-30 - documentador
- Etapa: Documentación de alcance para cliente (Ask mode)
- Cambio: Orquestador: Documentación cliente V10 (mismo día)
...
### 2026-07-30 - presupuestador
- Etapa: Cierre de calibración estimado vs real
- Cambio: Orquestador: Cierre de calibración V10 — PENDIENTE
...
### 2026-07-30
- Cambio: Deploy a producción V10
...
### 2026-07-31
- Cambio: Fix post-deploy: filtros de Consulta de Stock activos e independientes desde el primer render
...
### 2026-07-30 - implementador
- Etapa: Implementación (Agent mode)
- Cambio: Implementación V10 (mismo día)
...
### 2026-07-23
- Tema: Barrido cross-proyecto: mergeados runbook + metadata + as-built desde memoria local del repo
...
### 2026-07-30 - qa
- Etapa: QA (agente 6), sobre `5-implementador.md` sección V10 ya cerrada por el Implementador (build 0/0, `dotnet publish` para validar Razor).
- Cambio: Carga masiva de stock por Marca + filtros completos en Consulta de Stock
...
### 2026-08-08 - implementador
- Etapa: (Agent mode) — fix directo a pedido del cliente, sin pasar por Discovery/Diseño/Arquitectura/Presupuesto por tratarse de corrección de un patrón ya usado y aprobado en el mismo proyecto (`Stock/Index`, commit `4f7af9b` + Select2 sin commitear encontrado en el working tree)
- Cambio: V11 — fix directo de filtros server-side (Ventas/Compras/Devoluciones) + filtros Marca/Modelo activos en Productos
...
### 2026-08-11
- Cambio: Incidente producción: 500 en Carga Masiva de Stock
...
### 2026-08-11
- Cambio: Reversión de DD-1: Carga Masiva pasa de atomicidad total a guardado parcial
...
### 2026-08-11
- Cambio: Rediseño Vista Matriz de Stock (Marca → Modelo → Color × Talle)
...
### 2026-08-16 - qa
- Etapa: QA (agente 6), a pedido explícito del usuario ("hacer barrido QA" sobre todo lo acumulado desde el último gate formal). Sin definiciones 1/2/3 nuevas: los 11 commits se ejecutaron como fast-path directo, y `1-analista-funcional.md` / `2-disenador-funcional.md` (§V10, DD-1) quedaron deliberadamente desactualizados respecto de lo desplegado.
- Cambio: barrido del fast-path acumulado desde V10 (`d8a71ef..f400671`, 11 commits)
...
### 2026-08-16
- Cambio: Hotfix SG-001: D-01, D-02 y D-03 corregidos y desplegados
...
### 2026-08-16
- Cambio: Fixes puntuales a pedido del cliente tras el informe de gaps/bugs
...
### 2026-08-16
- Cambio: OBS-V10-02 cerrado: fusión de duplicados en producción + índice único
...
### 2026-08-16 - analista-funcional
- Etapa: Discovery + Análisis combinados (Ask mode, sin código)
- Cambio: Orquestador: Discovery + Análisis V12 (extensión de Matriz: accesorios + alta de Color nuevo)
...
### 2026-08-16 - disenador-funcional
- Etapa: Diseño (Ask mode, sin código)
- Cambio: Orquestador: Diseño funcional V12 (mismo día)
...
### 2026-08-16 - arquitecto-mvc
- Etapa: Arquitectura (Ask mode, sin código)
- Cambio: Orquestador: Arquitectura técnica V12 (mismo día)
...
### 2026-08-16 - presupuestador
- Etapa: Presupuesto (Ask mode, sin código)
- Cambio: Orquestador: Presupuesto V12 (mismo día) — GATE DURO, pendiente aprobación del cliente
...
### 2026-08-16 - implementador
- Etapa: Implementador (Agent mode)
- Cambio: Implementación V12 (mismo día)
...
### 2026-08-16 - qa
- Etapa: (Agent mode) — validación de la implementación V12 sobre working tree sin commitear
- Cambio: barrido V12 (mismo día)
...
### 2026-08-16
- Cambio: Fixes post-QA sobre V12 (D-V12-01, D-V12-02) + HU-12.4 retenida
...
### 2026-08-16
- Cambio: D-V12-03 resuelto: alta con stock inicial 0 + HU-12.4 liberada
...
### 2026-08-16
- Cambio: Deploy a producción V12
