...
- Pedirle: tabla por modulo funcional con O/M/P, PERT, contingencia, horas finales y USD segun formula vigente (M x $16.80); cargo de tokens IA (25% del total presupuestado); bloque de autocorreccion contra historicos.
...
- Todo presupuesto suma un cargo de tokens IA equivalente al 25% del total presupuestado (Etapa 1 + Etapa 2), como linea separada y visible en el total del proyecto.
