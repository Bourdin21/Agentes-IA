...
| la-platense | 2026-07-30 | **Entrega 1 en PRODUCCIÓN REAL** (https://ferreterialaplatense.com.ar/, migración aplicada, deploy vía Web Deploy 2026-08-11). Entrega 2 (Ventas/CC clientes/AFIP/Caja/Gastos/Entregas/Dashboard corte1) completa en rama `entrega-2`, build 0 errores, pendiente QA + prueba manual antes de su propio deploy — Entrega 3 sin arrancar | /docs/la-platense |
