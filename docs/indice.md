...
| marihogar | 2026-06-29 | Etapa 1 en producción. Deployado 2026-08-16: CR-37→CR-40 (modelo de precios Negro/Con IVA + cuotas + desc./recargo), fix crítico de maskMoney (MH-010), precarga AFIP (MH-011), y demás correcciones de la auditoría del 15/08 — 5 migraciones aplicadas, verificado sin pendientes. Certificado AFIP de producción cargado, disponible para pruebas del cliente pero todavía no usado. Etapa 2 en pausa | /docs/marihogar |
