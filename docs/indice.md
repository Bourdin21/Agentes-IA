...
|---|---|---|---|
| eleven-la-plata | 2025-07-01 | cerrado | /docs/eleven-la-plata |
...
| marihogar | 2026-06-29 | Etapa 1 en producción. Deployado 2026-08-19: CR-44 (pagos de OC programables + notificación), CR-45 (fecha de compra/recepción editable), CR-46 (% desc./recargo de Producto opcionales + cheque de compra no cuenta como pagado hasta acreditarse, con corrección retroactiva de 6 pagos), CR-47 (renombre "Negro"/"Con IVA" a "Precio efectivo"/"Precio de lista" en Ventas, solo texto) y CR-48 (Precio de lista de Producto editable, dejó de ser calculado) — 2 migraciones aplicadas (CR-44, CR-48). Certificado AFIP de producción cargado y en uso para las 6 facturas reales de la semana del 12/08 (CR-42/43). Etapa 2 en pausa | /docs/marihogar |
| crm-olvidata | 2026-07-14 | en producción, operativo | /docs/crm-olvidata |
| la-platense | 2026-07-30 | Entrega 1 en PRODUCCIÓN REAL. Entrega 2 completa en rama `entrega-2`, pendiente QA. Etapa 3 (migración de catálogo, USD 567 aprobado) — app-side implementada+QA GO en rama `migracion-catalogo` (commit `71daf36`, 2 bugs corregidos antes de commitear); falta aplicar la migración EF, correr las 10 pruebas manuales, y construir el script de extracción contra el backup real (paso 1, todavía no empezado) | /docs/la-platense |
