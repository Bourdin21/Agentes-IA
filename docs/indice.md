...
| la-platense | 2026-07-30 | Entrega 1 + Etapa 3 (migración de catálogo, incl. código de barras múltiple) en PRODUCCIÓN REAL, rama `entrega-1-migracion`. Entrega 2 (Ventas/Pagos/CC/Caja/Gastos/Entregas/Dashboard) reconciliada con producción (`entrega-2` mergeada + migración regenerada + ABC por lote restaurado, 2026-08-21) — pendiente QA real (nunca ejecutado) antes de deploy | /docs/la-platense |
