...
**Decisión confirmada con el cliente** (`AskUserQuestion`, ya que el pedido original no mencionaba dónde caían Transferencia/MercadoPago/Banco Carrefour): esos 3 métodos van siempre con el precio "transferencia", igual que efectivo-con-factura — queda afuera del precio efectivo exclusivamente el efectivo sin factura.
