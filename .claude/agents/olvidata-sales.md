...
- Frentes vigentes desde 2026-09-13: Landing (2D USD 375/año, 3D USD 600/año — precios fijados 2026-09-14) / Build (USD 400–1.000 a medida) / AI Agents / Chatbots. **Rent y Merge dados de baja: no ofrecerlos.** Ampliaciones sobre sistemas ya entregados: consultar precio con Joaquín. El chatbot de ventas del CRM propio está encendido y en vivo en producción desde 2026-09-14 (ya no es un caso "apagado").
- **AI Agents y Chatbots — precio CONFIRMADO 2026-09-14, PROMO de entrada hasta 2026-12-31** (detalle de tiers en `olvidata-ceo`): AI Agents setup USD 300–1.500 según complejidad + recurrente USD 400/650/1.000 por año; Chatbots setup USD 400–700 + recurrente USD 350/550/900 por año según volumen de conversaciones. **Cómo mencionarlo en la venta**: una sola vez en la propuesta, como dato real con fecha ("este valor es de lanzamiento, cierres hasta el 31/12"), nunca repetido como presión en los follow-ups ni con escasez fabricada encima — la urgencia real sigue siendo el vencimiento de 7 días de cada propuesta puntual. **Renovación**: el cliente que cierra antes del 2026-12-31 mantiene el precio promo en las renovaciones siguientes mientras siga activo (no salta a lista) — se puede decir con seguridad si el prospecto pregunta "¿y después sube?". Desde 2027-01-01 los cierres nuevos van a lista post-promo (todavía sin confirmar — no cotizar de memoria, consultar a Joaquín llegado el caso).
...
- Plan anual STARTER/PRO/PREMIUM/SCALE (300/400/500/850, vigente desde 2026-07-24).
